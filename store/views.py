...
from .serializers import AddCartItemSerializer, CreateOrderSerializer, ProductSerializer, CollectionSerializer, ReviewSerializer, CartSerializer,CartItemSerializer, AddCartItemSerializer,UpdateCartItemSerializer,CustomerSerilaizer, OrderSerializer,UpdateOrderSerializer
...
class CustomerViewSet(ModelViewSet):
    ...
    def me(self,request):
      ...
      if request.method == 'GET':
          serilaizer= CustomerSerilaizer(customer)
